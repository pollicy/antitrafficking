...
<body>
    <div class="container-fluid" data-spy="scroll" data-target=".navbar" data-offset="10">
      ...
      <div class="row">
        <div class="col-md-12">
          <nav class="navbar navbar-fixed-top" style="padding-bottom: 7px; background-color: #455a64; border-bottom: 1px solid #455a64;">
            <div class="container-fluid">
              <div class="navbar-header">
                <a class="navbar-brand navbar-left" href="#"><img src='logo.png' class='img-responsive'/></a>
              </div>
              <ul class="nav navbar-nav navbar-right">
                <li class="active"><a href="#home" data-toggle="tooltip" data-placement="left" title="home"  style="color: #fff !important;">home</a></li>
                <li><a href="#wetaase" data-toggle="tooltip" data-placement="left" title="wetaase"  style="color: #fff !important;">wetaase</a></li>
                <li><a href="#advisory" data-toggle="tooltip" data-placement="left" title="advisory"  style="color: #fff !important;">advisory</a></li>
                <li><a href="#resources" data-toggle="tooltip" data-placement="left" title="resources"  style="color: #fff !important;">resources</a></li>
                <!-- <li><a href="#stories" data-toggle="tooltip" data-placement="left" title="stories"  style="color: #fff !important;">stories</a></li> -->
                <li><a href="#map" data-toggle="tooltip" data-placement="left" title="immigration map"  style="color: #fff !important;">immigration map</a></li>
                <li><a href="#contact" data-toggle="tooltip" data-placement="left" title="contact"  style="color: #fff !important;">contact</a></li>
              </ul>
            </div>
          </nav>
        </div>
      ...
      <div class="row col-md-12" style="margin-top:5em;">
        <h3 class="text-center"><span class="label" style="background-color:#26c6da !important; color: #455a64 !important; opacity:0.9">Where are migrants coming from? Where have migrants left?</span></h3>
    ...
    <!-- begin footer -->
    <div class="row" id="footer" style="background-color:#455a64; color:#fff; height: 50px !important;">
      <div class="col-md-6">
        <h5>&copy <?php echo Date('Y') ?> Pollicy Uganda Limited</h5>
      </div>
      <div class="col-md-6">
